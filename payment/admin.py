...
class MainPaymentAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ['source_pyament_id', 'alnafi_pyament_id', 'easypaisa_ops_id', 'easypaisa_customer_msidn', 'card_mask', 'user', 'product', 'amount', 'currency', 'source', 'status', 'order_datetime', 'expiration_datetime', 'activation_datetime', 'token_paid_datetime', 'created_datetime', 'easypaisa_fee_pkr', 'easypaisa_fed_pkr', 'ubl_captured', 'ubl_reversed', 'ubl_refund', 'ubl_approval_code', 'description', 'qarz', 'remarks', 'payment_proof', 'send_invoice', 'pk_invoice_number', 'us_invoice_number', 'sponsored', 'coupon_code', 'is_upgrade_payment', 'affiliate', 's3_file_url', 's3_file_name', 'ubl_depositor_name', 'ubl_payment_channel', 'bin_bank_name', 'error_reason']
    search_fields = ('source_pyament_id', 'alnafi_pyament_id', 'easypaisa_ops_id', 'easypaisa_customer_msidn', 'card_mask', 'user__email', 'product__name', 'amount', 'currency', 'source', 'status', 'order_datetime', 'expiration_datetime', 'activation_datetime', 'token_paid_datetime', 'created_datetime', 'easypaisa_fee_pkr', 'easypaisa_fed_pkr', 'ubl_captured', 'ubl_reversed', 'ubl_refund', 'ubl_approval_code', 'description', 'qarz', 'remarks', 'payment_proof', 'send_invoice', 'pk_invoice_number', 'us_invoice_number', 'sponsored', 'coupon_code', 'is_upgrade_payment', 'affiliate', 's3_file_url', 's3_file_name', 'ubl_depositor_name', 'ubl_payment_channel', 'bin_bank_name', 'error_reason')
    list_filter = ('source', 'status', 'created_datetime', 'qarz', 'is_upgrade_payment')
