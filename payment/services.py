...
def no_of_payments(source):
    payments = Main_Payment.objects.exclude(product__product_name="test").exclude(amount=1).exclude(status=0).filter(source__in=['Easypaisa','UBL_IPG','Stripe','UBL_Manual','UBL_DD','ubl_dd'])
