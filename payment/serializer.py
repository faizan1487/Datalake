...
from .models import UBL_IPG_Payment, AlNafi_Payment, Main_Payment,Easypaisa_Payment, Stripe_Payment, UBL_Manual_Payment, New_Alnafi_Payments, Unpaid_New_Alnafi_Payments
...
class Unpaid_New_Al_Nafi_Payments_Serializer(ModelSerializer):
    class Meta:
        model = Unpaid_New_Alnafi_Payments
        fields = '__all__'
