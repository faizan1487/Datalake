# Generated by Django 4.1.5 on 2023-11-27 10:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0063_main_product_discount_applied_pkr_and_more'),
        ('payment', '0081_comment_new_alnafi_payments_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='main_payment',
            name='comment',
            field=models.ManyToManyField(blank=True, to='payment.comment'),
        ),
    ]
