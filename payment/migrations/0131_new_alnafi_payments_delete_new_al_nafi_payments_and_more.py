...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0112_main_product_discount_applied_pkr_and_more'),
        ('payment', '0130_new_alnafi_payments_delete_new_al_nafi_payments_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='unpaid_new_alnafi_payments',
            name='orderId',
