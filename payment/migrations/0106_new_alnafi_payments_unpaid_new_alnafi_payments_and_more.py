# Generated by Django 4.1.5 on 2024-01-04 07:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0087_main_product_discount_applied_pkr_and_more'),
        ('payment', '0105_new_alnafi_payments_delete_new_al_nafi_payments_and_more'),
    ]
    ...
    operations = [
        ...
        # ),
        migrations.CreateModel(
            name='Unpaid_New_Alnafi_Payments',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('orderId', models.CharField(max_length=255)),
                ('amount', models.IntegerField(blank=True, null=True)),
