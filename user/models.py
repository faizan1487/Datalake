...
class CvForms(models.Model):
    ...
    position_uplied_for = models.CharField(max_length=100,null=True, blank=True)
    work_experience = models.CharField(max_length=100,null=True, blank=True)
    date_you_can_start = models.CharField(max_length=100,null=True, blank=True)
    present_salary = models.CharField(max_length=100,null=True, blank=True)
    desired_salary = models.CharField(max_length=100,null=True, blank=True)
    academic_qualification = models.CharField(max_length=100,null=True, blank=True)
    descipline = models.CharField(max_length=100,null=True, blank=True)
    ...
    start_date_job = models.CharField(max_length=100,null=True, blank=True)
    end_date_job = models.CharField(max_length=100,null=True, blank=True)
    major_projects = models.CharField(max_length=100,null=True, blank=True)
    skills = models.CharField(max_length=100,null=True, blank=True)
    referance_name = models.CharField(max_length=100,null=True, blank=True)
    address_city = models.CharField(max_length=100,null=True, blank=True)
    referance_phone = models.CharField(max_length=100,null=True, blank=True)
    relationship_with = models.CharField(max_length=100,null=True, blank=True)
