...
from secrets_api.models import LastSecretApiUsing, AllSecretsApi,SupportLastSecretApiUsing, SupportAllSecretsApi, ExamLastSecretApiUsing, ExamAllSecretsApi
...
def round_robin_support():
    ...
    # print(last_creds.api_key)
    return last_creds.api_key, last_creds.secret_key
def round_robin_exam():
    last_creds = ExamLastSecretApiUsing.objects.first()
    all_creds = ExamAllSecretsApi.objects.all()
    # print(last_creds)
