...
from .views import AffiliateUsers, CreateAffiliateUser, CreateAffiliateClick, UserDelete, AffiliateUser

urlpatterns = [
    path("users/", AffiliateUsers.as_view(), name='affiliate-users'),
    path("affiliateuser/", AffiliateUser.as_view(), name='affiliate-user'),
